          ...
          PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                    PopupMenuItem<String>(
                        value: "1v1", child: Center(child: Text("nowy 1 vs 1"))),
                PopupMenuItem<String>(
                    value: "1v1", child: Center(child: Text("nowa gra łatwy"))),
                PopupMenuItem<String>(
                    value: "1v1", child: Center(child: Text("nowa gra trudny"))),
                  ])
        ],
      ),
      body: ListView(
